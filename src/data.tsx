export const skills = [
  {
    title: "React",
    contents: [
      "+ Proficient in React, with a strong ability to design and develop web and app services.",
      "+ Skilled in component architecture and refactoring to improve reusability and maintainability.",
      "+ Experienced in utilizing various React libraries, such as React-query, Recoil, and React Router.",
      "+ Led the migration from HTML/CSS to React, enhancing development efficiency and responsiveness of device."
    ],
  },
  {
    title: "JavaScript & TypeScript",
    contents: [
      "+ Proficient in JavaScript and TypeScript, with a deep understanding of both languages.",
      "+ Skilled in utilizing JavaScript frameworks, particularly React, to build responsive user interfaces and services.",
      "+ Utilized TypeScript with a strong understanding of type checking, classes, modules, and interfaces.",
      "+ Capable of working with third-party libraries and APIs.",
    ],
  },
  {
    title: "HTML & CSS",
    contents: [
      "+ Worked on projects with HTML5, CSS, SCSS, and Bootstrap to create visually appealing and well-structured web pages.",
      "+ Designed CSS animations using the @keyframes at-rule to create engaging user interactions.",
      "+ Utilized libraries such as styled-components and Framer Motion to streamline styling and animation tasks.",
    ],
  },
  {
    title: "Java",
    contents: [
      "+ Experienced with Spring Framework (MVC, JPA, Boot) for building robust and scalable web applications.",
      "+ Improved data structures, algorithms, and problem-solving skills for optimizing application performance.",
      "+ Developed Android applications using Java, ensuring seamless user experiences on mobile devices.",
    ],
  },
  {
    title: "PHP",
    contents: [
      "+ Utilized PHP for web development with a focus on server-side scripting and dynamic web page creation.",
      "+ Developed and maintained web applications, integrating PHP with HTML, CSS, and JavaScript.",
      "+ Employed PHP for server-side scripting and database connectivity.",
    ],
  },
  {
    title: "SQL & NoSQL",
    contents: [
      "+ Proficient in both SQL and NoSQL databases, with experience in data modeling, querying, and performance optimization.",
      "+ Designed and maintained relational databases using SQL, ensuring data integrity and efficient retrieval.",
      "+ Utilized NoSQL databases for flexible and scalable data storage in various applications.",
    ],
  },
];
...
export const projects = [
  {
    title: "Toad",
    date: "Nov 2022 - Feb 2023 (Group)",
    skills: ["React Native", "Expo", "StyleSheet", "Firebase"],
    github: "https://github.com/Hyukjoo-Lee/ReactNative_ToadApp",
    about: "Childcare Products Trading App",
    contents: [
      "Developing a React Native app as a cost-saving platform for trading used childcare products",
      "Implemented login, authentication, chat, and post features utilizing Firebase",
      "Fostered user trust with safe trade features and collaborated with college alumni",
    ],
  },
  {
    title: "JFLIX",
    date: "2022.07 ~ 2022.08 (Personal)",
    skills: [
      "ReactJS",
      "Typescript",
      "React-query",
    ...
    contents: [
      ...
      "Utilized API to fetch the data such as media trailer video, overview, and others used in the project",
    ],
  },
  {
    title: "Coin Tracker",
    date: "2022.07 ~ 2022.08 (Personal)",
    skills: ["ReactJS", "Typescript", "React-query", "Recoil", "Apexcharts"],
    github: "https://github.com/Hyukjoo-Lee/ReactJS_coinTracker",
    website: "https://hyukjoo-lee.github.io/ReactJS_coinTracker/",
    about: "Coin Tracker Website",
    contents: [
      "Designed and built a website that shows the top 100 always-up-to-date cryptocurrency information",
      "Visualized the detailed information with a 3-week price change chart using the ApexCharts library",
      "Utilized Cryptocurrency API to fetch the data used in the project",
    ],
  },
...
export const experiences = [
  
  {
    ...
    skills: ["React", "TypeScript" ,"Javascript", "MongoDB", "Express", "NodeJS", "Mantine"],
    position: "Software Developer (Full-time)",
    details: [
      "Migrated from a template framed in pure HTML/CSS to a template using ReactJS",
      "Refactored ReactJS components for improved render speed, code simplicity",
      "Worked closely with UI/UX designers using Mantine and Bootstrap",
      "Utilized ExpressJS for frontend API management, enabling efficient databasing in MongoDB",
      "Designed a Client-Server and RESTful architecture for seamless invitation processing",
      "Developed backend functionality for an RSVP system",
    ],
  },
  {
    title: "Signalchem Biotech Inc",
    date: "Feb 2023 - May 2023",
    skills: ["PHP", "Javascript", "Bootstrap UI", "MySQL"],
    position: "Software Developer (Part-time)",
    details: [
      "Built a PHP-based automation system to optimize the accounting team's invoice information retrieval",
      "Matched PO amounts with invoices, notifying admin users with visual and accurate results",
      "Improved user visibility by revamping web design using PHP, JS, and the Bootstrap UI framework",
      "Collaborated with UX/UI designers to transform Figma prototypes into websites to attract potential stakeholders"
    ],
  },
];
...
export const careers = [
  ...
  // },
  {
    ...
    date: "Feb 2023 - May 2023",
    about: "Worked as a software developer at SignalChem Biotech Inc",
  },
  {
    country: "Canada",
    title: "Software Developer (Full-time)",
    date: "May 2023 - Jan 2024",
    about: "Working as a software developer at YJMood",
  },
];
